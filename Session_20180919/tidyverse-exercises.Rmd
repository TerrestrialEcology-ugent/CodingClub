...
1. tidy the dataset, also separating leaf length from leaf width
2. compute leaf area
...
From the dataset obtained in 4.1, do the following:
...
# Bonus: create tibble and explore differences between tibble and dataframe
